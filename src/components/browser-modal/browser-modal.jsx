                    ...
                    <p>
                        { /* eslint-disable max-len */ }
                        {
                            props.error ? <FormattedMessage
                                defaultMessage="We are very sorry, but it looks like you are using a browser version that Bracelet Maker does not support. We recommend updating to the latest version of a supported browser such as Google Chrome, Mozilla Firefox, Microsoft Edge, or Apple Safari. "
                            ...
                            /> : <FormattedMessage
                                defaultMessage="We are very sorry, but Bracelet Maker does not support this browser. We recommend updating to the latest version of a supported browser such as Google Chrome, Mozilla Firefox, Microsoft Edge, or Apple Safari."
                            ...
                            values={{
                                previewFaqLink: (
                                    ...
                                    >
                                        <FormattedMessage
                                            defaultMessage="FAQ"
                                            description="link to Bracelet Maker FAQ page"
